...
SYSTEM_PROMPT = (
    ...
    "raising security generally increases protection but also tends to reject more suspicious opportunities; "
    "at higher security, some opportunities you selected may be blocked and not executed, reducing trade volume. "
    "lower security often allows more execution but increases risk of bad fills and attacks. "
    "active_nodes control execution capacity: more nodes can improve throughput, but usually increase operating cost and attack surface; "
    "too few nodes can create capacity bottlenecks and missed opportunities. "
    ...
    "Learn from each step's outcome (reward trend, blocked selections, and system state changes) and update your next action. "
    "Use Time Of Day, Session End Time, and Required Avg Net/Hour from the snapshot to calibrate urgency near close. "
    "Estimate remaining decision windows from these time signals and adjust aggression accordingly. "
